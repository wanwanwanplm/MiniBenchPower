...
支持命令：读数据(0x01) / 设 VI(0x02) / 输出控制(0x03) / 保存配置(0x04) / 恢复出厂(0x05) / 调PID(0x06) 
...
<img width="1885" height="1304" alt="image" src="https://github.com/user-attachments/assets/74de79aa-7c60-43cf-b209-b17629e8119f" />
<img width="2214" height="1381" alt="image" src="https://github.com/user-attachments/assets/e405ba37-4866-4daf-b56c-7523cc5fa85f" />
